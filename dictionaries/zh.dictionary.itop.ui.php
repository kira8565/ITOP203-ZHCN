...
Dict::Add('ZH CN', 'Chinese', '简体中文', array(
	...
	'Class:User/Error:AtLeastOneProfileIsNeeded' => '至少一个角色必须指定给该用户.',
));
...
Dict::Add('ZH CN', 'Chinese', '简体中文', array(
	'Class:URP_ProfileProjection' => '角色投射',
	'Class:URP_ProfileProjection+' => '角色投射',
...
Dict::Add('ZH CN', 'Chinese', '简体中文', array(
	'Class:URP_StimulusGrant' => '流转许可',
	'Class:URP_StimulusGrant+' => '对象生命周期中流转的许可',
	...
	'Class:URP_StimulusGrant/Attribute:permission/Value:no+' => '否',
	'Class:URP_StimulusGrant/Attribute:stimulus' => '流转',
	'Class:URP_StimulusGrant/Attribute:stimulus+' => '流转编码',
));
...
<li>管理您的 IT 中最重要的设施: 文档化.</li>
	...
	'UI:Error:Invalid_Stimulus_On_Object_In_State' => '错误: 在对象 %2$s 的 "%3$s" 状态上的无效流转 "%1$s" .',
...
//	'UI:Delete:MustBeDeletedManuallyButNotPossible' => '必须手工删除 - 但您未被允许删除该对象, 请联系您的应用程序系统管理员',
	...
	'UI:PageTitle:ProfileProjections' => 'iTop 用户管理 - 角色投射',
	...
	'UI:UserManagement:Profile+' => '投射被指定的角色',
	...
	'Menu:AdminTools+' => '管理工具',
	'Menu:AdminTools?' => '具有系统ADMIN_PROFILE_NAME角色的用户才能获得的工具',
...
当与一个触发器关联时, 每个动作都被赋予一个顺序号, 规定了按什么样的顺序执行这些动作.</p>',
	...
	'Portal:NoClosedRequest' => '该类目中没有请求',
	'Portal:Button:CloseTicket' => '关闭这个请求',
	...
	'Portal:AddAttachment' => ' 增加附件 ',
	'Portal:RemoveAttachment' => ' 删除附件 ',
	'Portal:Attachment_No_To_Ticket_Name' => '添加附件 #%1$d 给 %2$s (%3$s)',
	...
	'UI:Login:IncorrectLoginPassword' => '错误用户名/密码, 请再次偿试.',
	'UI:Login:IdentifyYourself' => '请输入用户名和密码',
	'UI:Login:UserNamePrompt' => '用户名',
	'UI:Login:PasswordPrompt' => '密码',
	'UI:Login:ForgotPwd' => '忘记密码?',
	'UI:Login:ForgotPwdForm' => '忘记密码',
	'UI:Login:ForgotPwdForm+' => 'Itop会向您发送一封电子邮件，你会发现说明，按照重置您的帐户.',
	'UI:Login:ResetPassword' => '发送!',
	'UI:Login:ResetPwdFailed' => '发送到Email失败: %1$s',
	'UI:Login:ResetPassword' => '发送!',

	'UI:Menu:ShortcutList' => '创建一个快捷方式...',
	'UI:ShortcutRenameDlg:Title' => '重命名快捷方式',
	'UI:ShortcutListDlg:Title' => '给列表创建一个快捷方式',
	'UI:ShortcutDelete:Confirm' => '请确认是否要删除改快捷方式.',
	'Menu:MyShortcuts' => '我的快捷方式',
	'Class:Shortcut' => '快捷方式',
	'Class:Shortcut+' => '',
	'Class:Shortcut/Attribute:name' => '名称',
	'Class:Shortcut/Attribute:name+' => '菜单和页面使用的标签',
	'Class:ShortcutOQL' => '搜索快捷方式',
	'Class:ShortcutOQL+' => '',
	'Class:ShortcutOQL/Attribute:oql' => '搜索',
	'Class:ShortcutOQL/Attribute:oql+' => 'OQL定义搜索的项目列表',
	'Class:ShortcutOQL/Attribute:auto_reload' => '自动更新',
	'Class:ShortcutOQL/Attribute:auto_reload/Value:none' => '不可用',
	'Class:ShortcutOQL/Attribute:auto_reload/Value:custom' => '默认',
	'Class:ShortcutOQL/Attribute:auto_reload_sec' => '自动更新间隔(秒)',
	'Class:ShortcutOQL/Attribute:auto_reload_sec+' => '最小5秒',
