...
'Menu:ServiceManagement+' => '服务管理概述',
'Menu:Service:Overview' => '概述',
'Menu:Service:Overview+' => '',
'UI-ServiceManagementMenu-ContractsBySrvLevel' => '基于服务级别的合同',
'UI-ServiceManagementMenu-ContractsByStatus' => '基于状态的合同',
'UI-ServiceManagementMenu-ContractsEndingIn30Days' => '30天内将结束的合同',
...
Dict::Add('ZH CN', 'Chinese', '简体中文', array(
	...
	'Class:Contract/Attribute:organization_name+' => '普通名称',
	'Class:Contract/Attribute:contacts_list' => '联系方式',
	'Class:Contract/Attribute:contacts_list+' => '这个客户合同的所有联系方式',
	'Class:Contract/Attribute:documents_list' => '文档',
	'Class:Contract/Attribute:documents_list+' => '这个客户合同的所有文档',
	'Class:Contract/Attribute:description' => '描述',
	'Class:Contract/Attribute:description+' => '',
	'Class:Contract/Attribute:start_date' => '开始日期',
	'Class:Contract/Attribute:start_date+' => '',
	'Class:Contract/Attribute:end_date' => '终止日期',
	...
	'Class:Contract/Attribute:billing_frequency' => '账单周期',
	'Class:Contract/Attribute:billing_frequency+' => '',
	'Class:Contract/Attribute:cost_unit' => '费用单元',
	...
	'Class:Contract/Attribute:status/Value:implementation' => '实施中',
	'Class:Contract/Attribute:status/Value:implementation+' => '实施中',
...
Dict::Add('ZH CN', 'Chinese', '简体中文', array(
	...
	'Class:CustomerContract/Attribute:functionalcis_list+' => '这个合同涉及的所有配置',
	'Class:CustomerContract/Attribute:providercontracts_list' => '供应商合同',
	'Class:CustomerContract/Attribute:providercontracts_list+' => '交付这个服务的所有供应商合同 (支撑合同)',
));
...
Dict::Add('ZH CN', 'Chinese', '简体中文', array(
	...
	'Class:ProviderContract/Attribute:functionalcis_list+' => '这个合同涉及的所有配置项',
	'Class:ProviderContract/Attribute:sla' => '服务级别协议',
	'Class:ProviderContract/Attribute:sla+' => '服务级别协议',
	'Class:ProviderContract/Attribute:coverage' => '服务小时',
...
Dict::Add('ZH CN', 'Chinese', '简体中文', array(
	'Class:lnkContactToContract' => '合同联系方式',
	'Class:lnkContactToContract+' => '',
	...
	'Class:lnkContactToContract/Attribute:contact_id' => '联系方式',
	'Class:lnkContactToContract/Attribute:contact_id+' => '',
	'Class:lnkContactToContract/Attribute:contact_name' => '联系方式名称',
...
Dict::Add('ZH CN', 'Chinese', '简体中文', array(
	'Class:lnkContractToDocument' => 'Link 合同 / 文档',
	'Class:lnkContractToDocument+' => '',
...
Dict::Add('ZH CN', 'Chinese', '简体中文', array(
	'Class:lnkFunctionalCIToProviderContract' => 'Link 功能项 / 供应商合同',
	'Class:lnkFunctionalCIToProviderContract+' => '',
...
Dict::Add('ZH CN', 'Chinese', '简体中文', array(
	'Class:Service' => '服务',
	'Class:Service+' => '',
	'Class:Service/Attribute:name' => '服务名称',
	'Class:Service/Attribute:name+' => '',
	'Class:Service/Attribute:org_id' => '组织',
	'Class:Service/Attribute:org_id+' => '',
	'Class:Service/Attribute:organization_name' => '名称',
	'Class:Service/Attribute:organization_name+' => '普通名称',
	'Class:Service/Attribute:description' => '描述',
	'Class:Service/Attribute:description+' => '',
	'Class:Service/Attribute:documents_list' => '文档',
	'Class:Service/Attribute:documents_list+' => '链接到这个服务的所有文档',
	'Class:Service/Attribute:contacts_list' => '联系方式',
	'Class:Service/Attribute:contacts_list+' => '这个服务的所有联系方式',
	'Class:Service/Attribute:status' => '状态',
	'Class:Service/Attribute:status+' => '',
	'Class:Service/Attribute:status/Value:implementation' => '实施中',
	'Class:Service/Attribute:status/Value:implementation+' => '实施中',
	...
	'Class:Service/Attribute:customercontracts_list+' => '购买这个服务的所有客户合同',
	'Class:Service/Attribute:servicesubcategories_list' => '服务子目录',
	'Class:Service/Attribute:servicesubcategories_list+' => '这个服务的所有子目录',
));
...
Dict::Add('ZH CN', 'Chinese', '简体中文', array(
	'Class:lnkDocumentToService' => 'Link 文档 / 服务',
	'Class:lnkDocumentToService+' => '',
...
Dict::Add('ZH CN', 'Chinese', '简体中文', array(
	'Class:lnkContactToService' => 'Link 联系 / 服务',
	'Class:lnkContactToService+' => '',
	'Class:lnkContactToService/Attribute:service_id' => '服务',
	'Class:lnkContactToService/Attribute:service_id+' => '',
	'Class:lnkContactToService/Attribute:service_name' => '服务名称',
	'Class:lnkContactToService/Attribute:service_name+' => '',
	'Class:lnkContactToService/Attribute:contact_id' => '联系方式',
	'Class:lnkContactToService/Attribute:contact_id+' => '',
	'Class:lnkContactToService/Attribute:contact_name' => '联系方式名称',
...
Dict::Add('ZH CN', 'Chinese', '简体中文', array(
	...
	'Class:ServiceSubcategory/Attribute:status/Value:implementation' => '实施中',
	'Class:ServiceSubcategory/Attribute:status/Value:implementation+' => '实施中',
...
Dict::Add('ZH CN', 'Chinese', '简体中文', array(
	...
	'Class:SLA/Attribute:slts_list+' => '这个SLA的所有服务级别目标',
...
Dict::Add('ZH CN', 'Chinese', '简体中文', array(
	'Class:lnkSLAToSLT' => 'Link 服务级别协议/服务级别目标',
	'Class:lnkSLAToSLT+' => '',
...
Dict::Add('ZH CN', 'Chinese', '简体中文', array(
	'Class:lnkCustomerContractToService' => 'Link 客户合同 / 服务',
	'Class:lnkCustomerContractToService+' => '',
	...
	'Class:lnkCustomerContractToService/Attribute:sla_name' => '服务级别协议名',
...
Dict::Add('ZH CN', 'Chinese', '简体中文', array(
	'Class:lnkCustomerContractToProviderContract' => 'Link 客户合同 / 供应商合同',
	'Class:lnkCustomerContractToProviderContract+' => '',
...
Dict::Add('ZH CN', 'Chinese', '简体中文', array(
	'Class:lnkCustomerContractToFunctionalCI' => 'Link 客户合同 / 功能配置项',
	'Class:lnkCustomerContractToFunctionalCI+' => '',
...
Dict::Add('ZH CN', 'Chinese', '简体中文', array(
	...
	'Class:DeliveryModel/Attribute:contacts_list+' => '关于这个交付模式的所有合同(团队和成员)',
...
Dict::Add('ZH CN', 'Chinese', '简体中文', array(
	'Class:lnkDeliveryModelToContact' => 'Link 交付模式 / 联系',
	'Class:lnkDeliveryModelToContact+' => '',
